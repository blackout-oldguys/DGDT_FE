  ...
  return (
    <div className="h-full w-full bg-slate-200 overflow-y-auto pb-3">
      ...
      <div className="relative">
        <div 
          className={`absolute inset-0 bg-contain bg-right bg-no-repeat opacity-30`}
          style={{ backgroundImage: "url('/logo_white.png')" }}
        ></div>
        
        <div className="max-w-3xl mx-auto pt-6 mb-5 relative">
          ...
          {currentStep === 3 && (
            <div className="w-full max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md mb-2 opacity-60">
          ...
          {currentStep === 4 && (
            <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md opacity-60">
                ...
                <div className="flex justify-center space-x-4">
                  <button
                    ...
                    className={`px-8 py-3 bg-blue-500 text-white rounded-lg font-semibold relative
                      ${isSubmitting ? 'opacity-60 cursor-not-allowed' : 'hover:bg-blue-600'}`}
                  >
                    {isSubmitting ? (
                      <>
